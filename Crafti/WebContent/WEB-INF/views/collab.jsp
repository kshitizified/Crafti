                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Apply for Land collaboration agreement</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 px-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter 10 digit contact number" value="" required>
                                                   ...
                                                   <label>Search Results</label> 
													<div class="table-responsive">          
														<table class="table">
																<thead>
																		<tr>
																			<th style="visibility:hidden">userid</th>
																...
																<tbody>
																		<tr>
																			<td style="visibility:hidden">1234</td>
																			<td>8800155208</td>
																			<td>Kshitiz</td>
																			<td>1001</td>
										...
										<div class="row">
											<div class="col-md-12 px-1">
                                                <div class="form-group">
                                                   <label>Added people in Agreement</label> 
												   <div class="table-responsive">          
														<table class="table">
																<thead>
																		<tr>
                                        ...
                                        <button type="submit" class="btn btn-info btn-fill pull-right" style="width:100%">Request Agreement</button>
