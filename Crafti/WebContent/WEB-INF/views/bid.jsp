                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
									...
									<form action="create-bid" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 px-1">
                                                <div class="form-group">
                                                    ...
                                                    placeholder="Name of item" value="" required name="name">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" 
                                                    placeholder="Item Description" value="" required
                                                    name="description" >
                                                </div>
                                            </div>
                                            <!--<div class="col-md-6 pl-1">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    placeholder="Price" value="" required name="price">
                                                </div>
                                            </div>
                                            <div class="col-md-4 px-1">
                                                <div class="form-group">
                                                    ...
                                                    value="" required name="quantity">
                                                </div>
                                            </div>
                                            <div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    <label>Type of Bid</label>
                                                    <select id="bidType" style="width:100%" class="dropdown" name="type">
														<option value=""></option>
														<option value="fixed">Fixed</option>
														<option value="bidding">Open to bidding</option>
                                        ...
                                        <button type="submit" class="btn btn-info btn-fill pull-right" onclick="validate()">Create bid</button>
...
<script>
function validate() {
        var e = document.getElementById("bidType");
