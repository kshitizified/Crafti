                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
									...
									<form action="rent" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Name of item" name="name" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <!--<div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    <select id="bidType" style="width:100%" class="dropdown">
														<option value=""></option>
                                        ...
                                        <button type="submit" class="btn btn-info btn-fill pull-right" style="width:100%">Put on rent</button>
...
<div class="table-responsive">    
	<h3>Items Available for Rent</h3>      
  <table class="table">
    <thead>
      <tr>
        <th></th>
